...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header page-header">
		...
		<div class="col-sm-8">
			<p><?php echo the_terms( $post->ID, 'country', 'Country: ', ', ', ' ' );?></p>		
			<p><?php echo the_terms( $post->ID, 'genre', 'Genre: ', ', ', ' ' );?></p>		
			<p><?php echo the_terms( $post->ID, 'year', 'Year: ', ', ', ' ' );?></p>		
			<p><?php echo the_terms( $post->ID, 'actors', 'Actors: ', ', ', ' ' );?></p>		
			<p>Ticket Price: <?php echo get_field( 'ticket_price', $post->ID ); ?></p>		
			<p>Release Date: <?php echo get_field( 'release_date', $post->ID ); ?></p>		
		</div>
		</div>
	...
	<div class="entry-content">
		...
		<?php if(of_get_option('blog_settings') == 1 || !of_get_option('blog_settings')) : ?>
			<?php the_excerpt( __( 'Continue reading <i class="fa fa-chevron-right"></i>', 'unite' ) ); ?>
